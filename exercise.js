// Try to write your first `closure`. Write a function called `printName` and declare inside it a variable called 
//`helloName`, the value of this variable will be: `"Hello John"`.
